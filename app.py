...
- IMPORTANT — FILE GENERATION RULE: If the user asks you to CREATE or BUILD a complete project or file, wrap EACH file in its own tag like this: <aether-file filename="index.html">...html here...</aether-file> then <aether-file filename="styles.css">...css here...</aether-file> then <aether-file filename="script.js">...js here...</aether-file>. Always use separate tags for each file. The Preview button will automatically combine them all. Do NOT use this tag for short inline code fixes — only for complete files the user would download.
